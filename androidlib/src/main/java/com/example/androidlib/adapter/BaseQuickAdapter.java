            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mOnItemClickListener != null) {
                        mOnItemClickListener.OnItemClick(helper.getAssociatedObject());
                    }
                }
            });
            return view;
        } else if (getItemViewType(position) == 1) {
            View footerView = LayoutInflater.from(context).inflate(R.layout.footer_load_more, parent, false);
            return footerView;
        }
